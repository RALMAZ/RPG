...
import TRAVISO from './game/lib/traviso';
...
var instanceConfig =
{
    mapDataPath : "./game/mapData.json", // the path to the json file that defines map data, required
    assetsToLoad : ["./game/assets/assets_map.json", "./game/assets/assets_characters.json"], // array of paths to the assets that are desired to be loaded by traviso, no need to use if assets are already loaded to PIXI cache, default null
